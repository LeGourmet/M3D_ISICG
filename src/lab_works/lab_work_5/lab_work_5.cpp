...
namespace M3D_ISICG
{
	...
	bool LabWork5::init()
	{
		...
		_scene.load("bunny","src/lab_works/common/models/bunny2/bunny_2.obj" );
	...
	void LabWork5::displayUI()
	{
		...
		if ( ImGui::RadioButton( "bunny", _model == model_LB5::bunny ) ){
			_model = model_LB5::bunny;
			_scene = TriangleMeshModel();
			_scene.load( "bunny", "src/lab_works/common/models/bunny2/bunny_2.obj" );
			_initCamera();
		}
		ImGui::SameLine();
		if ( ImGui::RadioButton( "sponza", _model == model_LB5::sponza )){
			_model = model_LB5::sponza;
			_scene = TriangleMeshModel();
			_scene.load( "sponza", "src/lab_works/common/models/sponza/sponza.obj" );
			_initCamera();
		}
